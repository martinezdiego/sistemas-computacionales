...
class Scene:
    ...
    def render(self, surface):
        ...
        surface.blit(settings.GAME_TEXTURES["sheet"], TileMap.to_screen(3, 3), settings.GAME_FRAMES["sheet"][110])
        surface.blit(settings.GAME_TEXTURES["sheet"], TileMap.to_screen(*self.target), settings.GAME_FRAMES["sheet"][87])
